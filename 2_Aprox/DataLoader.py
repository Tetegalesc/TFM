...
def DataLoader():
    ...
    features_to_scale = ['open', 'high', 'low', 'close', 'adjclose', 'SMA5', 'SMA10', 'SMA15', 'EMA5', 'EMA10', 'EMA15']
...
def DataScaling(df,features):
    ...
    # Scaling using 'close day before'
    for feat in features:
        df[feat] = (df[feat] - df['close_day_before']) / df['close_day_before']
    # Delete 'close day before' column
    df.drop(['close_day_before'], axis=1, inplace=True)
